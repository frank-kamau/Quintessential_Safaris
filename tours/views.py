    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if booking.__class__.objects.filter(
                ...
                return redirect('tour_detail', pk=tour.pk)  # ← Fixed: back to tour, not success
            ...
            email = EmailMessage(
                subject="Your QuintessentialSafaris tour Booking Confirmation",
                body=(
                    ...
                    f"Thank you for choosing QuintessentialSafaris."
                ),
            ...
            subject = "Booking Confirmation – QuintessentialSafaris"
            ...
            return redirect(f"/bookings/success/?reference={booking.reference}")  # ← Fixed: goes to success page
